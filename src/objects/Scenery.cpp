...
Scenery::Scenery() {
	...
	ground1.position = glm::vec2(0.f, SCREEN_SIZE.y - ground1.size.y);
	...
	ground2.position = glm::vec2(SCREEN_SIZE.x, ground1.position.y);
...
void Scenery::update() {
	...
	if (background1.position.x + SCREEN_SIZE.x < 0)
		background1.position.x = background2.position.x + SCREEN_SIZE.x;

	else if (background2.position.x + SCREEN_SIZE.x < 0)
		background2.position.x = background1.position.x + SCREEN_SIZE.x;
	...
	if (ground1.position.x + SCREEN_SIZE.x < 0)
		ground1.position.x = ground2.position.x + SCREEN_SIZE.x;

	else if (ground2.position.x + SCREEN_SIZE.x < 0)
