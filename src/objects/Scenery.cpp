...
#include <iostream>
Scenery::Scenery() {
	background1.size = glm::vec2(SCREEN_WIDTH, SCREEN_HEIGHT - 50);
	background1.setNormalizedTex(0, 0, 144, 256);

	background2.size = glm::vec2(SCREEN_WIDTH, SCREEN_HEIGHT - 50);
	background2.position = glm::vec2(background1.position.x + SCREEN_WIDTH -5, 0);
	background2.setNormalizedTex(0, 0, 144, 256);

	ground1.size = glm::vec2(SCREEN_WIDTH, 168);
	ground1.position = glm::vec2(0, SCREEN_HEIGHT - 160);
	...
	ground2.size = glm::vec2(SCREEN_WIDTH, 168);
	ground2.position = glm::vec2(ground1.position.x + SCREEN_WIDTH, SCREEN_HEIGHT - 160);
