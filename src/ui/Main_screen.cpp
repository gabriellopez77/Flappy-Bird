...
Main_screen::Main_screen() {
	...
	gameTitle_image.position = glm::vec2(SCREEN_WIDTH / 2 - gameTitle_image.size.x / 2, 50);
	gameTitle_image.setNormalizedTex(351, 91, 89, 24);

	start_button.size = glm::vec2(156, 100);
	start_button.position = glm::vec2(SCREEN_WIDTH / 2 - start_button.size.x - 10, SCREEN_HEIGHT - 300);
